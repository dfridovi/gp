...
macro(gp_subdir_list result curdir)
  file(GLOB children RELATIVE ${curdir} ${curdir}/*)
  set(digpist "")
  foreach(child ${children})
    if(IS_DIRECTORY ${curdir}/${child})
      list(APPEND digpist ${child})
    endif()
  endforeach()
  set(${result} ${digpist})
endmacro()
...
macro(gp_cpp_file_list result dir)
...
function(gp_set_runtime_directory target runtime_dir)
...
function(gp_default_properties target)
  set_target_properties(${target} PROPERTIES
